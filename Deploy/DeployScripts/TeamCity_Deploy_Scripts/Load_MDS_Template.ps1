...
[String]$DMTemplateFolder= $DeployBackupPath +"\TCConfiguration_" + $CurrentDate + "_" + $BuildNumber+"\DMTemplate",
[String]$FullFilePath= $DeployBackupPath +"\TCConfiguration_" + $CurrentDate + "_" + $BuildNumber+"\DMTemplate\Full_DMTemplate.txt",
[String]$DeltaFilePath= $DeployBackupPath +"\TCConfiguration_" + $CurrentDate + "_" + $BuildNumber+"\DMTemplate\Delta_DMTemplate.txt",
[String]$BatFilePath= $DeployBackupPath +"\TCConfiguration_" + $CurrentDate + "_" + $BuildNumber+"\DMTemplate\Import_DMTemplate.bat",
[String]$LogFilePath= $DeployBackupPath +"\TCConfiguration_" + $CurrentDate + "_" + $BuildNumber+"\DMTemplate\Log_DMTemplate.txt",
[String]$ErrorFilePath= $DeployBackupPath +"\TCConfiguration_" + $CurrentDate + "_" + $BuildNumber+"\DMTemplate\ErrorLog_DMTemplate.txt",
[String]$GitFileChangePath="SourceCode/Configuration/DMTemplate/",
...
if ($Found){
write-host "DMTemplates are modified !!"
# Remote Server.
...
$returncode
}-ArgumentList $BatFilePath, $HomePath, $InfodbaPWD, $FilePath, $LogFilePath, $ErrorFilePath, $DMTemplateFolder, $EmptyString
...
write-host "No Modifications to DMTemplates !!"
}
